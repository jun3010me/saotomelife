...
<div class="voice">
  ...
  <div class="voice-text-left">
    <p class="voice-text">
      でもこの前の話だと、なるべく細かく記録した方が後になって役立つこともあるんでしょ？
    </p>
  </div>
</div>
...
<div class="voice">
  ...
  <div class="voice-text-right">
    <p class="voice-text">
      ん〜〜〜、そりゃそうだけど〜、細かすぎると記録が続かないかもしれないから、無理のない程度でいいんだよ。
    </p>
  </div>
</div>
...
<img decoding="async" loading="lazy" class="alignnone size-full wp-image-14464" src="/wp-content/uploads/2018/07/Image-2018-07-26-14-55.jpeg" width="1280" height="1274"  sizes="(max-width: 1280px) 100vw, 1280px" /> 
...
<div class="voice">
  ...
  <div class="voice-text-right">
    <p class="voice-text">
      最初は顔を洗ったり髭を剃ったりっていうタスクを別で入れていたんだけどさ、たすくまを使っているうちにこのルーティンを体が覚えて無意識にやれてるから、「朝タスク」にまとめたんだよ。
    </p>
  </div>
</div>
...
<div class="voice">
  ...
  <div class="voice-text-right">
    <p class="voice-text">
      いつもスーパーで買い物してきてくれてありがとう。ところで買い物リストってどこに入れてるの？
    </p>
  </div>
</div>
...
<div class="voice">
  ...
  <div class="voice-text-left">
    <p class="voice-text">
      今はね、リマインダーに登録してるよ。朝の広告見ながら登録して、スーパーでリストを見ながらカゴに入れてくの。
    </p>
  </div>
</div>

<img decoding="async" loading="lazy" class="alignnone size-full wp-image-14465" src="/wp-content/uploads/2018/07/Image-2018-07-26-15-09.jpeg" width="720" height="1280"  sizes="(max-width: 720px) 100vw, 720px" /> 
...
<div class="voice">
  ...
  <div class="voice-text-right">
    <p class="voice-text">
      例えばだけど、たすくまのタスクに、メモとして画像を登録することもできるんだ。これならタスクを実行しながら、その画面で広告の写真を見れるよ。
    </p>
  </div>
</div>
